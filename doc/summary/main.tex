...
\input{../thesis/chapters/introduction/abstract.tex}

% \subsection{Modeling \texorpdfstring{\glsentryshort{inp}}{INP} resources}
% \input{../thesis/chapters/introduction/probstat/model.tex}
...
% \glsreset{rm}
% \input{../thesis/chapters/introduction/probstat/inp-rms.tex}

\section{Personal contribution}

\subsection{System design} \label{system_design}
The thesis introduces a system design comprising all steps needed to translate \glslink{resource:logical}{resources} expressed using the \gls{model:tenant} to \glslink{resource:physical}{physical ones} so that they could eventually be placed.
...
\input{../thesis/chapters/design/system/translation.tex}
...
\input{../thesis/chapters/design/model/proposal/main.tex}

\subsection{Generic groups}
\input{../thesis/chapters/design/groups/intro.tex}

\section{Obtained results}

\subsection{Simulation}
\input{../thesis/chapters/evaluation/simulator/intro.tex}\input{../thesis/chapters/evaluation/simulator/scheduler.tex}
\input{../thesis/chapters/evaluation/testbed.tex}
...
\input{../thesis/chapters/conclusions/intro.tex}

\subsubsection{Fully \texorpdfstring{\glsentryshort{inp}}{INP}-aware \texorpdfstring{\glsentryshort{rm}}{RM} features}
\input{../thesis/chapters/conclusions/fully-inp-aware-rms.tex}

% \subsubsection{Open problems}
% \input{../thesis/chapters/conclusions/openproblems.tex}
