...
\newsavebox\vocmodfigure \savebox\vocmodfigure{
    % trim = left, bottom, right, top
    \includegraphics[page=2, clip, trim=0.6cm 0.6cm 0.6cm 0.6cm, width=1\textwidth]{figures/design/model/variants.pdf}
}

\newsavebox\tagmodfigure \savebox\tagmodfigure{
    % trim = left, bottom, right, top
    \includegraphics[page=3, clip, trim=0.6cm 0.6cm 0.6cm 0.6cm, width=1\textwidth]{figures/design/model/variants.pdf}
}