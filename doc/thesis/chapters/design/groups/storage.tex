Both NetChain \cite{netchain} and IncBricks \cite{incbricks} make use of an distributed key-value map across \glslink{resource:physical:switch}{physical switches}, even if for a different purpose.
