...
\glsreset{stc}
Depending on the \gls{stc} value (\autoref{workload_tweaks}) and by the number of switch tasks required by different \gls{inp} solutions, \glslink{resource:logical:server}{server} and \glslink{resource:logical:switch}{switch} utilization may drop/increase at different rates.
\begin{figure}[!htb]
    \centering
