...
One problem that could arise is due to the fact that \gls{inp} resources are typically very limited in a data center: chapter ? will discuss the importance of an \gls{rm} which is flexible enough to propose alternatives based on the current utilization of \gls{inp} and server resources, since one kind of physical resource type can become the bottleneck for the other. % TODO