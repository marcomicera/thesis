...
\newglossaryentry{resource:physical}{
    ...
    \newglossaryentry{resource:physical:switch}{
        type=resources,
        name=Physical switch resource,
        text=physical switch resource,
        parent=resource:physical,
        description={resource of a physical switch, network accelerator, middle\hyp{}box and of every kind of network device originally intended to forward packets}
    }
...
\newglossaryentry{resource:composite}{
    ...
    name=Composite,
    text=composite,
    description={template describing a high\hyp{}level logical component.
    ...
    \newglossaryentry{resource:composite:server}{
        ...
        description={composite describing a high\hyp{}level server component, e.g., \textit{web server}, \textit{databases}, etc}
    }
    
    \newglossaryentry{resource:composite:inp}{
        type=resources,
        name=\gls{inp} composite,
        text=\texorpdfstring{\glsentryshort{inp}}{INP} composite,
        parent=resource:composite,
        description={composite describing a high\hyp{}level \gls{inp} application, e.g., \textit{IncBricks} \cite{incbricks}, \textit{NetChain} \cite{netchain}, etc}
    }
...
\newglossaryentry{model}{
    ...
    \newglossaryentry{model:rm}{
        type=resources,
        name=\gls{rm}\hyp{}side model,
        text=\texorpdfstring{\glsentryshort{rm}}{RM}-side model,
        parent=model,
